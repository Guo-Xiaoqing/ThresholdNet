...
class Configuration():
	def __init__(self):
		...
		self.DATA_CROSS = ''
		self.Threshold_margin = 0.3
		self.Alpha = 0.4
		self.Mixup_label_margin = 0.3
		self.Mixup_start_epoch = 50

		self.weight_ManifoldMixuploss = 0.5 ##CVC 0.5, WCE 0.1
		self.weight_MixupFeatureUpdate = 0.5 ##CVC 0.5, WCE 0.1
		self.weight_Similoss = 0.2 ##CVC 0.2, WCE 0.1
		#A: ThresholdType1Margin,  B: AdaptiveHardMixup,  C: ManifoldMixuploss,  D: MixupFeatureUpdate, E: Similoss
		self.EXP_NAME = 'CVC_lr001_384_256_A3_Ba4m3_C5_D5_E2_S50'+self.DATA_CROSS

		self.DATA_NAME = 'CVC'
		self.DATA_AUG = False
		self.DATA_WORKERS = 2
		self.DATA_RESCALE = 256
		self.DATA_RANDOMCROP = 384 ##CVC 384, WCE 256
