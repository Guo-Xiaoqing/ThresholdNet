...
#	optimizer = optim.SGD(net.parameters(), lr = cfg.TRAIN_LR, momentum=cfg.TRAIN_MOMENTUM)
	optimizer = optim.RMSprop(net.parameters(), lr=cfg.TRAIN_LR, momentum=0.0, weight_decay=cfg.TRAIN_WEIGHT_DECAY)
	...
	for epoch in range(cfg.TRAIN_MINEPOCH, cfg.TRAIN_EPOCHS):
		...
		for i_batch, sample_batched in enumerate(dataloader):
			...
			loss = criterion(predicts_batched, make_one_hot(labels_batched))
