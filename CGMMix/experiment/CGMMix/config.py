...
class Configuration():
	def __init__(self):
		...
		self.EXP_NAME = 'CVC_CE_lr001_384_256_CGMMix_Ba4m4_C5_D5_E2_S50'+self.DATA_CROSS
	...
	#	self.TRAIN_CKPT = os.path.join(self.ROOT_DIR,'./model/WCE125_lr001_256_256threshold_margin/deeplabv3plus_res101_atrous_WCE_epoch500_all.pth')
		...
		self.TEST_CKPT = os.path.join(self.ROOT_DIR,'./model/CVC_CE_lr001_384_256_CGMMix_Ba4m3_C5_D5_E2/model-best-deeplabv3plus_res101_atrous_CVC_epoch308_dice85.426.pth')
		self.TEST_GPUS = 2
