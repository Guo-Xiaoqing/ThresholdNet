...
class Configuration():
	def __init__(self):
		...
		self.EXP_NAME = 'CVC_CE_lr001_384_256_hardmixup'+self.DATA_CROSS
	...
	#	self.TRAIN_CKPT = os.path.join(self.ROOT_DIR,'./model/WCE125_lr001_256_256threshold_margin/deeplabv3plus_res101_atrous_WCE_epoch500_all.pth')
		...
		self.TEST_CKPT = os.path.join(self.ROOT_DIR,'/home/xiaoqiguo2/deeplabv3plus-pytorch/model/WCE_lr001_256_224/deeplabv3plus_res101_atrous_ISIC2017_epoch200_all.pth')
		self.TEST_GPUS = 2
