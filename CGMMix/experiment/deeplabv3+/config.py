...
class Configuration():
	def __init__(self):
		...
		self.DATA_CROSS = '3'
		self.EXP_NAME = 'DeepLabv3+WCE_CE_lr001_256_256_cross'+self.DATA_CROSS
		...
		self.TEST_CKPT = os.path.join(self.ROOT_DIR,'/home/xiaoqiguo2/Skin_jour1_threshold/model/deeplabv3+vocfinetuning_lr001_1000_512/deeplabv3plus_res101_atrous_ISIC2017_epoch200_all.pth')
		self.TEST_GPUS = 2
