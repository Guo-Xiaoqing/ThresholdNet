...
model_urls = {
    'xception': 'home/xiaoqiguo2/SPL/model/deeplabv3plus_xception_VOC2012_epoch46_all.pth'#'http://data.lip6.fr/cadene/pretrainedmodels/xception-b5690688.pth'
}
...
def xception(pretrained=True, os=16):
    ...
    if pretrained:
        old_dict = torch.load('/home/xiaoqiguo2/SPL/model/xception_pytorch_imagenet.pth')
