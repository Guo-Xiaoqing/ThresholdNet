...
class WCEDataset(Dataset):
    def __init__(self, dataset_name, cfg, period, aug=False):
        ...
        self.period = period
        self.img_dir = os.path.join(self.dataset_dir, 'TruePolyps')
        self.ann_dir = os.path.join(self.dataset_dir, 'TruePolypsMasks')
        self.seg_dir = os.path.join(self.dataset_dir, 'TruePolypsMasks')
    ...
    def __getitem__(self, idx):
        ...
        if 'train' in self.period:
            ...
            sample['segmentation'] = segmentation/1.
